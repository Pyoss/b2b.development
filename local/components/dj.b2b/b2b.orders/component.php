 ...
 */
$componentPage = '';
if (isset($arVariables['ORDER_ID']) && intval($arVariables['ORDER_ID']) > 0)
    $componentPage = 'order_detail'; // элемент инфоблока по идентификатору
else
    $componentPage = 'order_list'; // главная страница компонента
